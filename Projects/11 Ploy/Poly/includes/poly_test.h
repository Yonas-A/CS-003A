...
void test_big_three()
{
    ...
    cout << endl << " - - - Default Ctor Poly A - - - " << endl;
    Poly A;
    A += Term(1,3); A += Term(3,5);
    cout << "Poly A:    " << A << endl << endl;

    cout << endl << " - - - Ctor(array, order): Poly B - - - " << endl;
    int arr[5] = {2,3,4,9,5};
    Poly B(arr, 4);
    cout << endl << "Poly B:    " << B << endl << endl;

    cout << "   - - - Copy ctor: Poly C(B) - - - " << endl;
    Poly C(B);
    cout << "Poly B:    " << B << endl;
    cout << "Poly C:    " << C << endl << endl;

    cout << "  - - - Poly operator =(): Poly D = B - - - " << endl;
    Poly D;
    D = B;
    cout << "Poly B:    " << B << endl;
    cout << "Poly D:    " << D << endl << endl;
...
void test_delete_Zeros()
{
    ...
    cout << endl << "   - - - - - - - - - - - - - - \n" << endl;
    int arr[5] = {2,3,4,9,7};   int b_arr[5] = {2,3, 4,6, 7,};
    Poly A(arr, 4);
    Poly B(b_arr, 4);
...
void test_Poly_arithmetic_Term()
{
    ...
    cout << endl << "   - - - - - - - - - - - - - - \n" << endl;
    int arr[5] = {2,3,4,9,5};   int b_arr[4] = {2,3, 4, 7,};
    Poly A(arr, 4);
    Poly B(b_arr, 3);
    Term x(4,5);
    Term t(3,4);
...
void test_Poly_arithmetic_Poly()
{
    ...
    cout << endl << "    - - - D = B - A + Term(8,9) - - - " << endl;
    Poly D = B - A + Term(8,9);
    cout << B << " - " << A << " + [" << Term(8,9) <<"]" << endl << endl;
    cout << "  =  " << D << endl;
    cout << endl <<"   - - - - - - - - - - - - - -" << endl ;


    cout << endl << "    - - - E = D * B - - - " << endl;
    Poly E ;
    cout << D  << " * " << B  << endl << endl;
    E = D * B;
    cout << "  =  " << E << endl;
