...
class Vector {
   public:
    ...
    /// curly braces to initialize this class' private mem variable _vector
    ...
    /// \if position is less than vector size, erase item
    /// \else position is greater or equal to vector size, do nothing
