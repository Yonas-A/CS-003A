...
void test_Unique() {
    ...
    cout << "else test is sucessful" << endl
         << endl;
...
void test_Begin() {
    ...
    cout << endl
         << "\t------- test 2: list with 10 items --------" << endl;
    test_Insert(myList);
    begin = myList.Begin();
...
void test_Index_Of() {
    ...
    if (pos < 0)
        ...
        cout << "Index of [" << key << "] is " << pos << endl
             << endl;

    key = myList[4];
    cout << "----- test 2: Index of [" << key << "] -----" << endl
         << endl;
    iMarker = myList.Search(key, begin);
...
void test_Print() {
    ...
    myList.Print();
    cout << endl
         << "\t====== end of test Prev() ======" << endl
         << endl;
}

void test_Remove_Node() {
    cout << endl
         << "\t====== Test Remove_Node() ======" << endl
         << endl;
    Sorted<int> myList;
    test_Insert(myList);
    ...
    cout << "\t====== end of test Remove_Node() ======" << endl
         << endl;

    cout << "\t====== end of test Remove() ======" << endl
         << endl;
}

void test_Remove_Head() {
    cout << endl
         << "\t====== Test Remove_Head() ======" << endl
         << endl;
    Sorted<int> myList;
    test_Insert(myList);
    int removed;
    ...
    cout << "= = = end of test Remove_Head() = = =" << endl
         << endl;
}
...
void test_Where_This_Goes() {
    ...
    if (iMarker)
        cout << "It goes after " << *iMarker << endl
             << endl;
    else
        cout << "It goes as head ptr " << endl
             << endl;
    ...
    cout << "       TEST II: DESCENDING ORDER " << endl
         << endl;
