...
void test_big_three() {
    ...
    int key = 625;
    cout << "changing the front of myQ2 with " << key << endl
         << endl;
...
void test_Front() {
    ...
    cout << "changing the front of myQ" << endl
         << endl;
    *front = rand() % 1000;
    cout << myQ;

    cout << endl
         << "\t====== end of test Front( )  ======" << endl;
}
...
void test_Front_Overloaded() {
    ...
    cout << "-  -   - end of test Front( int)  - - - " << endl
         << endl;
}
...
void test_Operator_Bracket() {
    ...
    if (item)
        cout << "Item at myQ[" << pos << "] = " << item << endl
             << endl;
    else
...
void test_Search() {
    ...
    if (search)
        ...
        cout << "Cannot find item in list " << endl
             << endl;
